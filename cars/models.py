...
class CarModel(models.Model):
    ...
    avg_rating = models.DecimalField(max_digits=2, decimal_places=1, default=None, null=True)
...
class CarRate(models.Model):
    car_id = models.ForeignKey('CarModel', related_name='car_rate', on_delete=models.CASCADE)
